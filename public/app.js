...
var createUserBtn = document.getElementById("user_add_icon_holder");
...
createUserBtn.addEventListener("click", function () {
  ...
  myUsername = userInput.value.trim();
  ...
  if (username === "INFO") {
    ...
    chatDisplay.innerHTML += `<div class="message_holder ${
      username === myUsername ? "me" : ""
                                ...
                                <div class="pic"><img src="avatar-male.png" class="pic"  id="image"></div>
  ...
  for (var index in rooms) {
    roomlist.innerHTML += `<div class="room_card" id="${rooms[index].name}"
                                ...
                                <div class="room_item_content">
                                    <div class="pic"><img src="roo-logo.png" class="pic-room"  id="image"></div></div>
                                    <div class="roomInfo">
